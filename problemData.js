...
var PROB_TYPE_NUM = 15;

var PROB_NUM_WARMING_UP = 1;
var PROB_NUM_840 = 840;
var PROB_NUM_GUIDE = 30;
var PROB_NUM_OTHER_WISE = 26;
...
function getProblems(){
  ...
  for(var i = 1; i <= PROB_NUM_840; i++) problems.push(new Problem840(i));

  /* 基本パターン [ガイドあり] */
  for(var i = 1; i <= PROB_NUM_GUIDE; i++) problems.push(new ProblemWithGuidance(i));

  /* そのほか [ガイドあり] */
  for(var i = 1; i <= PROB_NUM_OTHER_WISE; i++) problems.push(new ProblemOtherwise(i));
